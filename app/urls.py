...
urlpatterns = [
    ...
    path('rent/', views.rent_now, name='rent-now'),
    path('profile/', views.ProfileView.as_view(), name='profile'),
    path('address/', views.address, name='address'),
    path('orders/', views.orders, name='orders'),
    path('earingsandnecklace/', views.earingsandnecklace, name='earingsandnecklace'),
    path('shoes/', views.shoes, name='shoes'),
    path('malewear/', views.malewear, name='malewear'),
    path('femalewear/', views.femalewear, name='femalewear'),
    ...
    PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html', form_class= MySetPasswordForm),
